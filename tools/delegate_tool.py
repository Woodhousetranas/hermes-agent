...
def _build_top_level_description() -> str:
    ...
    return (
        ...
        "Background delegations are NOT durable: if the parent session is "
        "closed (/new) or the process exits before a subagent finishes, "
        "that subagent's work is discarded, and /stop cancels every "
